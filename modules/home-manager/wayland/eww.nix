...
in
{
  config = {
    ...
    home.file.".config/eww-extras/mail-calendar-vars.yuck".text = ''
      ...
      (deflisten cal :initial `{ "title": "Loading...", "time": "00:00", "date": "2050-01-01" }` "~/.config/eww/scripts/get-next-calendar-entry.nu single")
      (defpoll events :initial "[]" :interval "30s" "~/.config/eww/scripts/get-next-calendar-entry.nu all")
    '';
