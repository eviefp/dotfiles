{ dotfiles, pkgs, lib, ... }:
{
  ...
  config.programs.waybar = {
    ...
    # can also be file
    style = ''
      @define-color backgroundlight #C18CDF;
      @define-color backgrounddark #FFFFFF;
      @define-color workspacesbackground1 #1F0A08;
      @define-color workspacesbackground2 #FFFFFF;
      @define-color bordercolor #C82CB7;
      @define-color textcolor1 #C656A1;
      @define-color textcolor2 #5086A5;
      @define-color textcolor3 #FFFFFF;
      @define-color iconcolor #C3985A;
