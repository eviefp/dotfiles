  ...
  where
    ...
    xrandr =
      [ ("M-a", Xrandr "xrandr --output HDMI-1 --mode 1920x1080 --right-of DP-4"),
        ...
        ("M-x", Xrandr "xrandr --output DP-0 --mode 1920x1080 --rate 239.76 --left-of DP-2; xrandr --output DP-2 --mode 1920x1080 --rate 239.76 --primary; xrandr --output DP-4 --mode 1920x1080 --rate 239.76 --right-of DP-2")
      ]
